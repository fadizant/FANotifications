...
static CGFloat const kDefaultCardViewHeight = 41.f;
...
+ (instancetype)showCardAlertWithTitle:(NSString *)title
    ...
    ISMessages* alert = [[ISMessages alloc] initCardAlertWithTitle:title
                                                       ...
                                                       hideOnSwipe:hideOnSwipe
                                                         hideOnTap:hideOnTap
                                                         alertType:ISAlertTypeNone
                                                     alertPosition:position];
    alert.alertViewBackgroundColor = color;
    ...
    alert.titleLabelTextColor = (brightness < 0.75) ? [UIColor whiteColor] : [UIColor blackColor];
    alert.messageLabelTextColor = (brightness < 0.75) ? [UIColor whiteColor] : [UIColor blackColor];
...
- (void)viewDidLoad {
    ...
    self.messageLabelHeight = (_messageString && ![_messageString isEqualToString:@""]) ? ceilf([self preferredHeightForMessageString:_messageString]) : 0;
    self.titleLabelHeight = (_titleString && ![_titleString isEqualToString:@""]) ? ceilf([self preferredHeightForTitleString:_titleString]) : 0;
...
- (void)constructAlertCardView {
    ...
    if (_titleString && ![_titleString isEqualToString:@""]) {
        ...
        titleLabel.textAlignment = self.iconImage ? [self alignmentForString:_titleString] : NSTextAlignmentCenter;
    ...
    if (_messageString && ![_messageString isEqualToString:@""]) {
        ...
        messageLabel.textAlignment = self.iconImage ? [self alignmentForString:_titleString] : NSTextAlignmentCenter;
