...
@synthesize notificationLabel, notificationLabelTextColor, notificationLabelFont, notificationWindow, customView;//notificationLabelBackgroundColor
...
-(void)setNotificationLabelBackgroundColor:(UIColor *)color{
    _notificationLabelBackgroundColor = color;
    ...
    if (color) {
        ...
        self.notificationLabelTextColor = (brightness < 0.75) ? [UIColor whiteColor] : [UIColor blackColor];
    }
}
...
- (void)createStatusBarView
{
    ...
    if (self.notificationAnimationType == CWNotificationAnimationTypeReplace) {
        ...
        [statusBarImageView setFrame:RectSetHeight([self getNotificationLabelFrame], [UIScreen mainScreen].bounds.size.height)];
